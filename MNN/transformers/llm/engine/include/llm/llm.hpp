...
public:
    ...
    int getValidLogitStart() const;
    int getValidLogitSize() const;
    ...
    void setExtraInputNames(const std::vector<std::string>& names);
    void setExtraInputs(const Express::VARPS& inputs);
...
protected:
    ...
    std::vector<std::string> mExtraInputNames;
    Express::VARPS mExtraInputs;
